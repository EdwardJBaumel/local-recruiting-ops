...
import { LroMark } from "@/components/LroMark";
 ...
 *
 * Brand mark: LRO pipeline icon in an accent-tinted chip.
 */
        ...
        <div className="bg-destructive/15 border-b border-destructive/30 text-destructive text-sm">
          <div className="container py-2 flex items-center gap-2">
            ...
            <span>
              ...
              (or double-click <span className="font-mono">Start Local Recruiting Ops.cmd</span>) to bring up the Python API.
            </span>
          </div>
        </div>
      )}
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2.5">
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-accent/10 ring-1 ring-accent/25 shadow-[0_0_20px_-8px_hsl(var(--accent)/0.8)]">
                <LroMark className="h-[18px] w-[18px] text-accent" />
              </div>
              <div className="flex items-baseline gap-2">
                <h1 className="text-lg font-semibold tracking-tight">Local Recruiting Ops</h1>
                <span className="text-xs text-muted-foreground hidden sm:inline">
                  local-first recruiting ops
                </span>
              </div>
            </div>
