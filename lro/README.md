# Local Recruiting Ops — code

Local Recruiting Ops is two processes that talk over HTTP on `localhost`:
...
The split is intentional even though Local Recruiting Ops is a single-user tool:
