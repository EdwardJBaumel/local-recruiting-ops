...
def _default() -> dict:
    ...
    # Lazy import: user_store is imported very early in startup and we
    # want to keep its import graph tight. helper is pure-python with
    # no heavy deps so this is cheap either way.
