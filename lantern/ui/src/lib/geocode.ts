 ...
 * removal commit and `lantern/api/core/preferences.py LocationFilter`
...
// _REMOTE_TOKENS in lantern/api/core/geocode.py — keep them in sync
 ...
 * in lantern/api/core/preferences.py — keep both lists in sync.
 *
